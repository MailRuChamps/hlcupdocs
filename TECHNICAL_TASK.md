...
> Чтобы приступить к выполенению [задания](TECHNICAL_TASK.md#Описание-задачи-highload-cup-2017), вам необходимо скачать архив с тестовыми [данными](../data/TRAIN) в формате JSON (данные вы также можете скачать с сайта проведения конкурса [https://highloadcup.ru](https://highloadcup.ru)). 
