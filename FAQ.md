...
> Необходимо сначала создать, а затем и развернуть производительный сервер приложения, который будет реализовывать необходимое задачей `Web API`. [Подробнее](https://github.com/sat2707/hlcupdocs/blob/master/TECHNICAL_TASK.md#Описание-задачи-highload-cup-2017)
...
верных ответов, которые успел дать [API](https://github.com/sat2707/hlcupdocs/blob/master/TECHNICAL_TASK.md#Описание-api) во время обстрела. Прибавляется к этому штрафное время для каждого неправильного ответа или запроса, ответ
...
---------------------------------------------------------------------
> Подробнее об этом вы можете прочитать [здесь](https://github.com/sat2707/hlcupdocs/blob/master/TECHNICAL_TASK.md).
...
----------------------------------------------------------
> Подробнее об этом вы можете прочитать [здесь](https://github.com/sat2707/hlcupdocs/blob/master/TECHNICAL_TASK.md#Шаг-1).
