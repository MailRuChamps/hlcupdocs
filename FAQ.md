...
верных ответов, которые успел дать [API](https://github.com/sat2707/hlcupdocs/blob/master/TASK.md#Описание-api) во время обстрела. Прибавляется к этому штрафное время для каждого неправильного ответа или запроса, ответ
