...
верных ответов, которые успел дать [API](https://github.com/SannikovDmitry/hlcupdocs/blob/master/TECHNICAL_TASK.md#Описание-api) во время обстрела. Прибавляется к этому штрафное время для каждого неправильного ответа или запроса, ответ
